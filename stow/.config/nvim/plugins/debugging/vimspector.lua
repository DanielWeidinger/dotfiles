...
wk.register({
	d = {
		...
		C = { "<Plug>VimspectorToggleConditionalBreakpoint<cr>", "◯ :Condidional" },
...
-- TODO: load and save breakpoints w/ sessions https://github.com/puremourning/vimspector#breakpoints
